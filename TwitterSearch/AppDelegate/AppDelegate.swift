...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func addTwitterLikeAnimation(){
        self.window = UIWindow(frame: UIScreen.main.bounds)
        self.window!.backgroundColor = #colorLiteral(red: 0, green: 0.6745098039, blue: 0.9333333333, alpha: 1)
        ...
        navigationController.view.layer.mask?.contents = UIImage(named: "twitterWhite")!.cgImage
